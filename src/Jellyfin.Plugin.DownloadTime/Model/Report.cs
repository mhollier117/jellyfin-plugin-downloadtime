...
public sealed record MissingEpisodeDto(
    ...
    string Classification = "Episode", // Episode | Special | Extra — separate axis from Kind (Gap/New)
    int? RuntimeMinutes = null);       // source-reported duration behind the classification
